...
<title>{{ __('Услови за користење') }} — KADAR</title>
...
<div class="wrap">
  <div class="doc">
    ...
    <p>{{ __('Со креирање профил или користење на KADAR (платформата), се согласуваш со овие Услови за користење. Ако не се согласуваш, немој да ја користиш платформата.') }}</p>

    <h2>2. {{ __('Што е KADAR') }}</h2>
    ...
    <p>{{ __('KADAR ја обезбедува платформата „како што е" и не гарантира непрекинат или безгрешен пристап. Платформата не одговара за квалитетот на извршената работа, ниту за спорови меѓу клиенти и креативци настанати надвор од директната контрола на платформата.') }}</p>
