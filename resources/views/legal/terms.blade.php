...
<div class="wrap">
  <div class="doc">
    ...
    <p>{{ __('Условите за плаќање (цена, динамика, начин на исплата) за проекти ги договараат клиентот и креативецот директно меѓу себе — платформата не обработува такви плаќања. Пристапот до одредени функции на платформата (пребарување, пораки) бара активна претплата, наплатена преку нашиот платежен партнер Paddle.com, кој дејствува како Merchant of Record. Секоја страна презема сопствен ризик при склучување договор надвор од платформата.') }}</p>
