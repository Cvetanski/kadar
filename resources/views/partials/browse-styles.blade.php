<style>
    ...
    .br-details-back{
        display:none;align-items:center;gap:6px;background:#fff;border:1.5px solid #0B6FE0;
    ...
    .br-details-back:hover{background:#EAF2FE;border-color:#0958B5;color:#0958B5;transform:translateY(-1px);
