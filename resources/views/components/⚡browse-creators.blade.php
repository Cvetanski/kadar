...
new class extends Component
{
    ...
    {
        $this->reset(['search', 'categoryIds', 'skillIds', 'countryId', 'priceMin', 'priceMax', 'remoteOnly', 'sortBy']);
        $this->resetPage();
    }
    ...
    <div class="br-layout">
        ...
        <aside class="br-filters {{ $showFilters ? 'is-open' : '' }}">
            <div class="br-filters-head">
                <span>{{ __('Филтри') }}</span>
                @if ($search !== '' || $categoryIds !== [] || $skillIds !== [] || $countryId || $priceMin || $priceMax || $remoteOnly || $sortBy !== 'latest')
