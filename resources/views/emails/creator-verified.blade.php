...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;border:1px solid #E8EBF0;overflow:hidden;">
    ...
    <tr>
        <td style="padding:28px 32px 0;">
            <span style="display:inline-block;background:#E9F9EF;color:#0A7D3C;font-size:11.5px;font-weight:700;letter-spacing:.02em;padding:6px 12px;border-radius:999px;">
                🎉 {{ __('Верификуван профил') }}
            </span>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:24px 32px 28px;border-top:1px solid #E8EBF0;margin-top:8px;">
            <p style="margin:20px 0 0;color:#9AA0AB;font-size:11.5px;line-height:1.6;">
                {{ __('Го добиваш ова затоа што твојот профил на CreatorSpot е верификуван. Известувањата можеш да ги исклучиш во твоите поставки.') }}
            </p>
        </td>
    </tr>
