...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;border:1px solid #E8EBF0;overflow:hidden;">
    ...
    <tr>
        <td style="padding:16px 32px 6px;">
            <h1 style="margin:0;font-size:21px;font-weight:800;color:#14171F;letter-spacing:-0.01em;line-height:1.35;">{{ $chatMessage->sender->name }}</h1>
        </td>
    </tr>
    <tr>
        <td style="padding:0 32px 24px;">
            <p style="margin:0;color:#666B76;font-size:14px;line-height:1.6;">{{ __('Ти испрати нова порака на CreatorSpot.') }}</p>
        </td>
    </tr>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F6F8FB;border-radius:12px;">
                <tr>
                    <td style="padding:18px 20px;">
                        <p style="margin:0;font-size:14px;line-height:1.6;color:#14171F;">{{ \Illuminate\Support\Str::limit($chatMessage->body, 280) }}</p>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="background-color:#0B6FE0;background:linear-gradient(135deg,#2D82E8,#0958B5);border-radius:10px;">
                        <a href="{{ route('messages.show', $chatMessage->conversation) }}"
    ...
    <tr>
        <td style="padding:24px 32px 28px;border-top:1px solid #E8EBF0;margin-top:8px;">
            <p style="margin:20px 0 0;color:#9AA0AB;font-size:11.5px;line-height:1.6;">
                {{ __('Го добиваш ова затоа што имаш нова порака на CreatorSpot. Известувањата можеш да ги исклучиш во твоите поставки.') }}
            </p>
        </td>
    </tr>
