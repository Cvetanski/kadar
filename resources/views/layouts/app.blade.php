...
@php
    $description ??= __('KADAR поврзува видеографи, фотографи, дизајнери, дигитални маркетери и едитори директно со клиенти низ Балканот.');
    $pageTitle = $title ? "{$title} | KADAR" : 'KADAR — '.__('Пронајди го твојот следен креативец');
@endphp
