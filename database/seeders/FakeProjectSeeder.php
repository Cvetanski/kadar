...
class FakeProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($this->projects() as $data) {
            ...
            // Some remote projects are genuinely location-agnostic (open to
            // anyone, anywhere) rather than tied to the client's own
            // country — hide_location drops the project's country so it
            // doesn't get pulled into country-filtered browse results.
            $projectCountryId = ($data['hide_location'] ?? false) ? null : $countryId;
    ...
    private function projects(): array
    {
        return [
            ...
            ['id' => 6, 'client' => 'Wei Ling Tan', 'country' => 'SG', 'category' => 'video-production', 'remote_ok' => false, 'deadline_days' => 30, 'created_days_ago' => 4,
            ...
            ['id' => 16, 'client' => 'Yuki Tanaka', 'country' => 'JP', 'category' => 'photography', 'remote_ok' => false, 'deadline_days' => 30, 'created_days_ago' => 8,
            ...
            // Digital Marketing
            ['id' => 18, 'client' => 'David Reynolds', 'country' => 'US', 'category' => 'digital-marketing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 1000, 'budget_max' => 3000, 'deadline_days' => 30, 'created_days_ago' => 1,
            ...
            ['id' => 20, 'client' => 'James Whitfield', 'country' => 'GB', 'category' => 'digital-marketing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 500, 'budget_max' => 1500, 'deadline_days' => 21, 'created_days_ago' => 4,
            ...
            ['id' => 25, 'client' => 'Fatima Al Zaabi', 'country' => 'AE', 'category' => 'digital-marketing', 'remote_ok' => true, 'deadline_days' => 30, 'created_days_ago' => 3,
            ...
            // Video Editing
            ['id' => 26, 'client' => 'Brandon Lee', 'country' => 'US', 'category' => 'video-editing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 800, 'budget_max' => 2000, 'created_days_ago' => 5,
            ...
            ['id' => 29, 'client' => 'Tomas Bakker', 'country' => 'NL', 'category' => 'video-editing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 600, 'budget_max' => 1500, 'deadline_days' => 21, 'created_days_ago' => 8,
            ...
            ['id' => 32, 'client' => 'Felix Wagner', 'country' => 'DE', 'category' => 'video-editing', 'remote_ok' => true, 'deadline_days' => 45, 'created_days_ago' => 9,
            ...
            // Design
            ['id' => 34, 'client' => 'Nathan Walsh', 'country' => 'US', 'category' => 'design', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 1500, 'budget_max' => 4000, 'deadline_days' => 30, 'created_days_ago' => 2,
            ...
            ['id' => 36, 'client' => 'Mart Tamm', 'country' => 'EE', 'category' => 'design', 'remote_ok' => true, 'deadline_days' => 45, 'created_days_ago' => 6,
            ...
            ['id' => 39, 'client' => 'Henry Clarke', 'country' => 'GB', 'category' => 'design', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 1200, 'budget_max' => 3000, 'deadline_days' => 30, 'created_days_ago' => 13,
            ...
            ['id' => 41, 'client' => 'Linh Nguyen', 'country' => 'VN', 'category' => 'design', 'remote_ok' => false, 'deadline_days' => 30, 'created_days_ago' => 10,
            ...
            // Content Creator / UGC
            ['id' => 43, 'client' => 'Ashley Kim', 'country' => 'US', 'category' => 'content-creator', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 500, 'budget_max' => 1500, 'deadline_days' => 21, 'created_days_ago' => 1,
            ...
            ['id' => 44, 'client' => 'Jasmine Reid', 'country' => 'GB', 'category' => 'content-creator', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 600, 'budget_max' => 1600, 'created_days_ago' => 8,
            ...
            ['id' => 47, 'client' => 'Nicha Suwan', 'country' => 'TH', 'category' => 'content-creator', 'remote_ok' => false, 'deadline_days' => 30, 'created_days_ago' => 14,
            ...
            ['id' => 50, 'client' => 'Pablo Ruiz', 'country' => 'ES', 'category' => 'content-creator', 'remote_ok' => false, 'deadline_days' => 30, 'created_days_ago' => 12,
            ...
            // Video Editing — extra listings, so this category has meaningfully more volume
            ['id' => 51, 'client' => 'Valentina Torres', 'country' => 'MX', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 400, 'budget_max' => 1000, 'created_days_ago' => 3,
                'title' => 'Instagram Reels Editing for a Beauty Brand — Weekly',
                'description' => 'We shoot raw product and tutorial footage every week and need someone to turn it into polished Instagram Reels — trending audio, on-screen text, and quick cuts. Roughly 6-8 reels per week on an ongoing basis. Looking for someone who already understands beauty/skincare content trends.'],
            ['id' => 52, 'client' => 'Nadia Meier', 'country' => 'CH', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 1500, 'budget_max' => 3500, 'deadline_days' => 45, 'created_days_ago' => 7,
                'title' => 'Corporate Training Video Series — 8 Modules',
                'description' => "We've recorded raw footage for an 8-module internal training series and need it edited into polished, consistent videos — trimming dead air, adding lower-thirds for speaker names, simple on-screen text for key points, and our company intro/outro on each module. Each module runs roughly 8-12 minutes of raw footage. We'll provide a brand template with our logo, colors, and fonts so the modules feel consistent across the whole series. This isn't glamorous content, but clarity and pacing matter since employees will actually be tested on this material. We have a rough six-week window but modules can be delivered in batches rather than all at once. Please share a corporate or e-learning video edit if you have one, even a short sample."],
            ['id' => 53, 'client' => 'Dylan Foster', 'country' => 'US', 'category' => 'video-editing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 250, 'budget_max' => 600, 'created_days_ago' => 0,
                'title' => 'Twitch VOD Highlight Editing — Weekly',
                'description' => 'I stream a few times a week and need someone to pull highlight clips from my VODs and edit them into short, punchy videos for YouTube and TikTok. Looking for an ongoing weekly arrangement, roughly 3-4 clips per stream. Familiarity with gaming content and comedic timing is a big plus.'],
            ['id' => 54, 'client' => 'Sipho Dlamini', 'country' => 'ZA', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 500, 'budget_max' => 1200, 'deadline_days' => 21, 'created_days_ago' => 11,
                'title' => 'Corporate Webinar Editing and Repurposing',
                'description' => "We run monthly webinars and want the raw recordings cleaned up — trimming the awkward start/end, fixing audio levels, adding our branding overlay — and then repurposed into 4-5 short clips for social media per webinar. We'll provide the raw Zoom recording and a short list of the strongest moments to prioritize for clips, but you're welcome to suggest better ones if you spot them. This would ideally become a recurring monthly arrangement if the first one goes well. Please share an example of a webinar or talking-head edit you've delivered before."],
            ['id' => 55, 'client' => 'Rafael Costa', 'country' => 'BR', 'category' => 'video-editing', 'remote_ok' => true, 'deadline_days' => 14, 'created_days_ago' => 5,
                'title' => 'Short Film Trailer Cut',
                'description' => "We've finished our short film and need a 60-90 second trailer cut to submit alongside our festival applications. Full film footage and a temp music track will be provided. Looking for someone with a good sense of pacing for suspense/drama rather than a straightforward recap."],
            ['id' => 56, 'client' => 'Isabella Clarke', 'country' => 'NZ', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 300, 'budget_max' => 800, 'created_days_ago' => 16,
                'title' => 'Real Estate Video Tour Editing — Monthly Retainer',
                'description' => 'We film raw walkthrough footage for property listings and need someone to edit them into clean 60-90 second tours with our branded intro and background music. Roughly 8-10 properties per month on an ongoing basis. Consistent turnaround within 48 hours of receiving footage is important since listings go live on a schedule.'],
            ['id' => 57, 'client' => 'Grace Thompson', 'country' => 'US', 'category' => 'video-editing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 200, 'budget_max' => 500, 'created_days_ago' => 2,
                'title' => 'Multi-Camera Church Service Editing — Weekly',
                'description' => 'We record our Sunday service with three cameras and need someone to edit it into a single clean multi-cam video each week for our YouTube channel. Includes basic audio mixing and our standard intro/outro. Looking for a reliable weekly turnaround, ideally posted by Monday evening.'],
            ['id' => 58, 'client' => 'Erik Lindqvist', 'country' => 'SE', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 700, 'budget_max' => 1600, 'deadline_days' => 21, 'created_days_ago' => 9,
                'title' => 'Corporate Case Study Video Editing',
                'description' => "We've filmed interviews with three customers for a case study video series and need someone to edit each into a polished 2-3 minute video — cutting down the interview into a clear narrative, adding lower-thirds, b-roll we'll provide, and light background music. Each video should feel consistent with the others in pacing and style since they'll live together on our website. We can share a rough script/outline of the story arc we're going for on each one, though the interviews weren't scripted so some restructuring will be needed. Please share a customer testimonial or case study video edit you've done previously if you have one."],
            ['id' => 59, 'client' => 'Piotr Kowalski', 'country' => 'PL', 'category' => 'video-editing', 'remote_ok' => true, 'created_days_ago' => 6,
                'title' => 'Gaming Montage Editing for a YouTube Channel',
                'description' => 'Looking for an editor to turn raw gameplay recordings into fast-paced montage videos with good sound design and transitions. Ongoing arrangement, roughly one video every 1-2 weeks. Please share a montage or gaming edit example, ideally something with a similar fast-cut style.'],
            ['id' => 60, 'client' => 'Beatriz Costa', 'country' => 'PT', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 400, 'budget_max' => 1000, 'deadline_days' => 21, 'created_days_ago' => 14,
                'title' => 'Travel Vlog Editing — 4 Episodes',
                'description' => "I filmed a 2-week trip and have raw footage for what should become 4 vlog episodes, roughly 8-12 minutes each. Looking for someone to handle the full edit — selects, pacing, color, music, and light captions for key moments. I can share a rough narrative outline per episode but I'm open to your editorial judgment on what footage works best."],
            ['id' => 61, 'client' => 'Aisyah Rahman', 'country' => 'MY', 'category' => 'video-editing', 'remote_ok' => true, 'hide_location' => true, 'budget_min' => 600, 'budget_max' => 1500, 'deadline_days' => 30, 'created_days_ago' => 8,
                'title' => 'Corporate Onboarding Video Series Editing',
                'description' => "We've recorded raw footage for a 5-part new-hire onboarding video series covering company culture, benefits, tools, and team introductions, and need it edited into polished, consistent videos with our branding applied throughout. Each part runs 5-10 minutes of raw footage and should end up as a clean 3-5 minute final cut. We'll provide a simple brand kit (logo, colors, intro/outro template) to keep everything consistent across all five parts. This series will be used for every new hire going forward, so it needs to hold up well over time rather than feeling like a quick one-off edit. Please share any corporate or internal-communications video work you've done previously."],
            ['id' => 62, 'client' => 'Marcus Webb', 'country' => 'US', 'category' => 'video-editing', 'remote_ok' => true, 'budget_min' => 350, 'budget_max' => 900, 'created_days_ago' => 1,
                'title' => 'Podcast Clips for TikTok/Reels — 20 Clips per Episode',
                'description' => 'We release a weekly podcast and want someone to pull the best moments from each episode and turn them into 20 short vertical clips for TikTok, Reels, and Shorts. Captions and simple visual treatment (waveform or speaker cam) expected on each clip. Looking for a consistent weekly turnaround and a good editorial eye for which moments will actually perform.'],

            // Digital Marketing — extra listings focused on social media & content strategy
            ['id' => 63, 'client' => 'Valeria Gómez', 'country' => 'CO', 'category' => 'digital-marketing', 'remote_ok' => true, 'budget_min' => 400, 'budget_max' => 1000, 'deadline_days' => 21, 'created_days_ago' => 5,
                'title' => 'Social Media Content Calendar — 3 Platforms',
                'description' => "We need someone to plan and build out a full content calendar across Instagram, TikTok, and LinkedIn for the next quarter — post ideas, captions, and a posting schedule, though we'll handle the actual filming/design execution ourselves. Looking for a strategic thinker who can tie posts back to our broader marketing goals, not just a list of random content ideas. Please share an example of a content calendar or social strategy document you've built previously."],
            ['id' => 64, 'client' => 'Petra Nováková', 'country' => 'CZ', 'category' => 'digital-marketing', 'remote_ok' => true, 'hide_location' => true, 'deadline_days' => 21, 'created_days_ago' => 10,
                'title' => 'Content Strategy for a B2C Email Newsletter',
                'description' => "Our email newsletter has decent open rates but engagement has been flat and we're not sure our content is actually resonating with subscribers. We're looking for a content strategist to review our past few months of newsletters, our audience data, and competitor newsletters in our space, then deliver a clear content strategy — themes, cadence, and structure — we can start executing ourselves. This is a strategy engagement, not ongoing newsletter writing, though we'd be open to discussing that separately afterward if it goes well. Please share a content strategy document or similar deliverable you've produced before, even in summary form."],
        ];
    }
}
